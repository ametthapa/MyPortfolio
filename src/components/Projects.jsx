        ...
        <div className="border border-gray-200 shadow-md group">
          ...
          <div className="p-5">
            ...
            <div>
              <div>
                <ul className="flex">
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 outline-none">React</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Express</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">MongoDB</div></li>
                </ul>
              </div>
              <div className="py-5">
                <a
          ...
          <div className="p-5">
            ...
            <div>
              <div>
                <ul className="flex">
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 outline-none">React</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Tailwind</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Responsive</div></li>
                </ul>
              </div>
              <div className="py-5">
              <a
        ...
        <img src="../image/third.png" alt="Expense Tracker" className="h-52 group-hover:scale-105" />
          <div className="p-5">
            ...
            <div>
              <div>
                <ul className="flex">
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 outline-none">JavaScript</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">HTML</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Vanilla JS</div></li>
                </ul>
              </div>
              <div className="py-5">
              <a
          ...
          <div className="p-5">
            ...
            <div>
              <div>
                <ul className="flex">
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 outline-none">JavaScript</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Fetch API</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">Vanilla JS</div></li>
                </ul>
              </div>
              <div className="py-5">
            ...
            <div>
              <div>
                <ul className="flex">
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 outline-none">JavaScript</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">HTML</div></li>
                  <li className="py-2"><div className="border bg-gray-100 text-darkBlack p-2 ml-2 outline-none">DOM Manipulation</div></li>
                </ul>
              </div>
              <div className="py-5">
              <a
